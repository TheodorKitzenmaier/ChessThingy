...
/**
 * Desc: First basic AI player, looks [n + 1] turns into the future and evaluates based on material, check, checkmate, and draw
 * Date: 6/10/22
 * @author Theodor Kitzenmaier <tkitzenm at asu.edu>
 */
public class CountingAIPlayerAB extends Player
{
    //instance vars
     ...
     * @param draw 
     */
    public CountingAIPlayerAB(char color, String name, int material, int check, int mate, int draw)
    {
        super(color, name);
